...
This is where the fun begins. From my knowledge of nextjs, you can use getStaticProps to fetch data at build time. I'm curious if the page would fetch blog posts created after the build.
...
- ChatGPT can give h**elpful answers even when given vague questions**.
...
- ChatGPT is an amazing tool for learning new technologies and discovering new libraries.
...
Using ChatGPT as a programming assistant was an interesting and successful experience. I generated a significant portion of the code for my blog using the model, and it also helped me learn new technologies and concepts. Although ChatGPT proved a helpful tool, I wouldn't rely on it solely for code generation. Instead, it is a valuable resource to consult when learning or improving my workflow. I don't believe it will replace developer jobs in the near future, but developers who use ChatGPT as a tool to enhance their skills will have an advantage. In short, ChatGPT is a senior engineer I can bother with no repercussions 🙂.